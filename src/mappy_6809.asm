...
A000: 10 CE 17 80 LDS    #$1780
A004: CC 00 00    LDD    #$0000
A007: FD 13 E4    STD    $13E4
A00A: 8E D0 20    LDX    #$D020
...
A215: B6 13 89    LDA    $1389
A218: 80 02       SUBA   #$02
A21A: B7 13 89    STA    $1389
A21D: 81 01       CMPA   #$01
...
A292: 08 6C       ASL    <$6C
A294: 00 6A       NEG    <$6A
A296: 78 0C 70    ASL    $0C70
A299: 00 8A       NEG    <$8A
A29B: 78 0C 74    ASL    $0C74
A29E: 00 AA       NEG    <$AA
A2A0: 78 0C 78    ASL    $0C78
A2A3: 00 AA       NEG    <$AA
A2A5: 68 08       ASL    $8,X
A2A7: 7C 00 CA    INC    >$00CA
A2AA: 68 04       ASL    $4,X
A2AC: 00 00       NEG    <$00
A2AE: 86 3C       LDA    #$3C
...
A49A: 50          NEGB
A49B: 04 86       LSR    <$86
A49D: FF B7 13    STU    $B713
A4A0: 89 BD       ADCA   #$BD
A4A2: BC 49 BD    CMPX   $49BD
A4A5: BC B1 CC    CMPX   $B1CC
A4A8: 00 28       NEG    <$28
A4AA: DD 01       STD    <$01
A4AC: 86 A0       LDA    #$A0
A4AE: 97 04       STA    <$04
...
A8FD: 86 FF       LDA    #$FF
A8FF: B7 13 89    STA    $1389
A902: BD E3 83    JSR    $E383
A905: 86 1E       LDA    #$1E
A907: 8D 62       BSR    $A96B
A909: BD D0 8A    JSR    $D08A
A90C: B6 13 89    LDA    $1389
A90F: 80 02       SUBA   #$02
A911: B7 13 89    STA    $1389
A914: 81 13       CMPA   #$13
A916: 26 6D       BNE    $A985
...
A958: B6 13 89    LDA    $1389
A95B: 8B 02       ADDA   #$02
A95D: B7 13 89    STA    $1389
A960: 81 FF       CMPA   #$FF
A962: 26 21       BNE    $A985
A964: 86 3C       LDA    #$3C
A966: 8D 03       BSR    $A96B
...
A984: 39          RTS
A985: B6 48 03    LDA    $4803
A988: 84 0F       ANDA   #$0F
A98A: 26 08       BNE    $A994
A98C: B6 48 02    LDA    $4802
A98F: 84 0F       ANDA   #$0F
A991: 26 01       BNE    $A994
A993: 39          RTS
...
AA29: B6 13 89    LDA    $1389
AA2C: 80 04       SUBA   #$04
AA2E: B7 13 89    STA    $1389
AA31: 81 13       CMPA   #$13
AA33: 27 21       BEQ    $AA56
AA35: 39          RTS
AA36: 50          NEGB
...
B6D8: AB 2F       ADDA   $F,Y
B6DA: 20 32       BRA    $B70E
B6DC: 30 30       LEAX   -$10,Y
B6DE: 20 AA       BRA    $B68A
B6E0: 2F 20       BLE    $B702
B6E2: 32 30       LEAS   -$10,Y
B6E4: 30 30       LEAX   -$10,Y
B6E6: 20 AA       BRA    $B692
B6E8: 2F 00       BLE    $B6EA
B6EA: 14          XHCF
B6EB: C0 01       SUBB   #$01
...
B6FA: A0 00       SUBA   $0,X
B6FC: 18          X18
B6FD: 10 00 4C    NEG    <$4C
B700: 20 FF       BRA    $B701
B702: 01 6C       NEG    <$6C
B704: 18          X18
B705: 01 40       NEG    <$40
B707: 38 01       XANDCC #$01
B709: 10 18       X18
B70B: 00 E8       NEG    <$E8
B70D: 48          ASLA
B70E: 00 B0       NEG    <$B0
B710: 30 00       LEAX   $0,X
B712: 78 18 00    ASL    $1800
B715: 7C A8 00    INC    $A800
B718: 4C          INCA
B719: 68 FF 01 6C ASL    [$016C]
B71D: 30 01       LEAX   $1,X
B71F: 38 20       XANDCC #$20
B721: 01 08       NEG    <$08
B723: 30 00       LEAX   $0,X
B725: DC 20       LDD    <$20
B727: 00 A8       NEG    <$A8
...
BA38: B6 13 89    LDA    $1389
BA3B: 80 02       SUBA   #$02
BA3D: B7 13 89    STA    $1389
BA40: 81 13       CMPA   #$13
BA42: 27 01       BEQ    $BA45
BA44: 39          RTS
BA45: 86 6C       LDA    #$6C
...
BBAF: 8D 37       BSR    $BBE8
BBB1: B6 13 89    LDA    $1389
BBB4: 8B 01       ADDA   #$01
BBB6: B7 13 89    STA    $1389
...
BBCD: 8D 19       BSR    $BBE8
BBCF: B6 13 89    LDA    $1389
BBD2: 8B 01       ADDA   #$01
BBD4: B7 13 89    STA    $1389
BBD7: 81 FF       CMPA   #$FF
BBD9: 27 01       BEQ    $BBDC
BBDB: 39          RTS
...
BFDF: FF FF FF    STU    $FFFF
BFE2: FF FF FF    STU    $FFFF
BFE5: FF FF FF    STU    $FFFF
BFE8: FF FF FF    STU    $FFFF
BFEB: FF FF FF    STU    $FFFF
BFEE: FF FF FF    STU    $FFFF
BFF1: FF FF FF    STU    $FFFF
BFF4: FF FF FF    STU    $FFFF
BFF7: FF FF FF    STU    $FFFF
BFFA: FF FF FF    STU    $FFFF
BFFD: FF FF B0    STU    $FFB0
...
DFFF: BF CE 07    STX    $CE07
E002: B0 CC 20    SUBA   $CC20
E005: 20 ED       BRA    $DFF4
E007: C1 11       CMPB   #$11
E009: 83 07 C0    SUBD   #$07C0
E00C: 26 F8       BNE    $E006
...
E039: B6 48 02    LDA    $4802
E03C: 84 0F       ANDA   #$0F
E03E: 27 0A       BEQ    $E04A
E040: A7 C2       STA    ,-U
E042: B6 48 03    LDA    $4803
E045: 84 0F       ANDA   #$0F
E047: A7 C2       STA    ,-U
E049: 39          RTS
E04A: B6 48 03    LDA    $4803
E04D: 84 0F       ANDA   #$0F
E04F: A7 C2       STA    ,-U
E051: 86 20       LDA    #$20
E053: A7 C2       STA    ,-U
...
E60B: 24 12       BCC    $E61F
E60D: FC 13 89    LDD    $1389
E610: E3 06       ADDD   $6,X
E612: 25 05       BCS    $E619
E614: FD 13 89    STD    $1389
E617: 20 06       BRA    $E61F
E619: CC FF 00    LDD    #$FF00
E61C: FD 13 89    STD    $1389
...
E778: 24 0A       BCC    $E784
E77A: FC 13 89    LDD    $1389
E77D: A3 06       SUBD   $6,X
E77F: FD 13 89    STD    $1389
E782: 20 06       BRA    $E78A
E784: CC 18 00    LDD    #$1800
E787: FD 13 89    STD    $1389
...
E948: A6 41       LDA    $1,U
E94A: 48          ASLA
E94B: CE E9 50    LDU    #jump_table_e950
...
EADE: 20 0C       BRA    $EAEC
EAE0: FE FF FF    LDU    $FFFF
EAE3: FF 00 00    STU    >$0000
EAE6: 00 01       NEG    <$01
EAE8: 01 01       NEG    <$01
EAEA: 02 80       XNC    <$80
EAEC: 96 29       LDA    <$29
...
F142: 24 39       BCC    $F17D
F144: B6 13 89    LDA    $1389
F147: AB 5F       ADDA   -$1,U
F149: 24 02       BCC    $F14D
F14B: 86 FF       LDA    #$FF
F14D: B7 13 89    STA    $1389
F150: 20 2B       BRA    $F17D
F152: A6 02       LDA    $2,X
F154: AB C0       ADDA   ,U+
F156: 24 02       BCC    $F15A
...
F16F: 86 18       LDA    #$18
F171: 20 05       BRA    $F178
F173: B6 13 89    LDA    $1389
F176: A0 5F       SUBA   -$1,U
F178: B7 13 89    STA    $1389
F17B: 20 00       BRA    $F17D
F17D: A6 04       LDA    $4,X
F17F: AB C0       ADDA   ,U+
F181: A7 04       STA    $4,X
...
reset_f504:
F504: 1A FF       ORCC   #$FF
F506: B7 50 02    STA    $5002
F509: B7 50 04    STA    $5004
F50C: B7 50 0A    STA    $500A
F50F: B7 50 08    STA    $5008
...
F9C8: 8B 10       ADDA   #$10
F9CA: 27 01       BEQ    $F9CD
F9CC: 71 7E FA    NEG    $7EFA
F9CF: 79 B6 13    ROL    $B613
F9D2: 89 B7       ADCA   #$B7
F9D4: 13          SYNC
F9D5: 8B 10       ADDA   #$10
F9D7: 26 00       BNE    $F9D9
...
FBC0: B6 48 05    LDA    $4805
FBC3: 84 0A       ANDA   #$0A
FBC5: 27 17       BEQ    $FBDE
FBC7: F6 13 89    LDB    $1389
FBCA: 84 08       ANDA   #$08
FBCC: 27 07       BEQ    $FBD5
FBCE: C0 02       SUBB   #$02
FBD0: 24 09       BCC    $FBDB
...
FBD7: 24 02       BCC    $FBDB
FBD9: C6 FF       LDB    #$FF
FBDB: F7 13 89    STB    $1389
FBDE: B6 48 04    LDA    $4804
FBE1: BA 48 06    ORA    $4806
FBE4: 84 0F       ANDA   #$0F
FBE6: 26 07       BNE    $FBEF
FBE8: BA 48 07    ORA    $4807
FBEB: 84 0F       ANDA   #$0F
FBED: 27 25       BEQ    $FC14
...
FF2B: 58          ASLB
FF2C: 49          ROLA
FF2D: 8E 38 00    LDX    #$3800
FF30: 30 8B       LEAX   D,X
FF32: A7 84       STA    ,X
FF34: 8E 11 00    LDX    #$1100
FF37: CE 17 80    LDU    #$1780
...
FF9D: 81 03       CMPA   #$03
FF9F: 26 0B       BNE    $FFAC
FFA1: B6 48 00    LDA    $4800
FFA4: 7F 48 00    CLR    $4800
FFA7: 84 0F       ANDA   #$0F
